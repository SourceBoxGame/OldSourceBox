...
public:
	...
	virtual QScriptObject GetArgObject(QScriptArgs args, int argnum);
	...
	virtual QScriptObject CreateFunctionObject(const char* name, const char* args, QCFunc funcptr);
